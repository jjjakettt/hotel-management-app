...
import FlexPaymentModal from "@/components/FlexPaymentModal/FlexPaymentModal";
...
const RoomDetails = (props: { params: Promise<{ slug: string }> }) => {
    ...
    const handleBookNowClick = async () => {
        ...
        // Open payment modal instead of Stripe redirect
        setIsPaymentModalOpen(true);
    };

    const handlePaymentSuccess = async (bookingDetails: any) => {
        try {
            // Create the booking in your backend/Sanity
            await createBooking({
                ...bookingDetails,
                paymentStatus: 'AUTHORIZED', // Mark as authorized but not paid
    ...
    const calculateTotalPrice = () => {
        ...
        if (!numberOfDays || !room) return 0;
        
        const discountPrice = room.price - (room.price / 100) * room.discount;
        return discountPrice * numberOfDays;
    };

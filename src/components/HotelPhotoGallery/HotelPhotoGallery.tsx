...
const HotelPhotoGallery: FC<{photos: ImageType[]}>= ({photos}) => {
    ...
    // handlePrevious and handleNext helps with navigating photos in the gallery
    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-2 relative gap-5 px-3">
                <div className="h-[540] relative rounded-2xl overflow-hidden">
                    {/* Large Devices */}
                ...
                {showModal && 
                    <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black/50 z-[55]">
                        <div className="h-[75vh] w=[320px] md:w-[700px] relative">
                            ...
                            <button 
                                ...
                                onClick={closeModal}
                            >
                                <MdCancel className="scale-animation font-medium text-2xl text-white" />
                            </button>
